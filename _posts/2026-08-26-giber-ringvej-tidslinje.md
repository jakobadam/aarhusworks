...
<div class="findings">
  ...
  <ol>
    ...
    <li><strong>Den samme jordvold forklares på to måder.</strong> Over for Retten i Aarhus forklarede kommunen, at volden ved Nymarksvej blev bygget efter <em>"en frivillig aftale med lodsejeren"</em>, og at der var <em>"færre omkostninger (...) end ved at flytte jorden"</em>. Over for borgerne indgår den blandt de 16 volde, der er opgjort til 18,5 mio. kr. af puljen. Hvilken <strong>merudgift</strong> volden lagde beslag på, er aldrig udskilt. <a href="/assets/giber-ringvej/2025-04-07-dom-retten-i-aarhus-bs-38128-2021-arh.pdf#page=57">Dommen</a> · <a href="/assets/giber-ringvej/2023-08-Ramboll-redegoerelse.pdf#page=3">Redegørelsen</a></li>
    ...
    <li><strong>Kommunen kan ikke oplyse, hvor meget den "støjdæmpende" asfalt dæmper.</strong> Projektet forudsatte en SRS-belægning; der blev udlagt KVS. Hverken referencebelægning, type eller dokumenteret reduktion er oplyst. Vejdirektoratets notat opgør de fremhævede <em>"ca. 2 dB"</em> i forhold til SMA11 — ikke i forhold til den SMA8, der udgør <em>"ca. 70 %"</em> af statsvejnettet. <a href="/assets/giber-ringvej/2019-08-vejdirektoratet-kvs-asfalt.pdf#page=4">Figuren</a></li>
...
<ul class="tl">
  ...
  <li class="tl-item">
    ...
    <div class="tl-body">
      ...
      <p class="tl-title">I retten forklares den samme vold anderledes</p>
      ...
      <p class="tl-text">Netop den vold er én af de 16, kommunen over for borgerne har opgjort til 18,5 mio. kr. af puljen. Udsagnet i retten sammenligner to måder at håndtere den samme overskudsjord på og siger ikke, at volden var gratis. Men det viser, hvad kommunen aldrig har udskilt: hvilken <strong>merudgift</strong> ud over den almindelige jordhåndtering der kan henføres til en støjmæssig funktion — og det er merudgiften, en pulje til <em>øget</em> støjdæmpning skulle dække.</p>
    </div>
  </li>
